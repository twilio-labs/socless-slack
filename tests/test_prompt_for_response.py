'''Test prompt_for_response lambda function'''
...
#     import functions.prompt_for_response.lambda_function as lambda_function
...
def test_prompt_for_response_incomplete_inputs():
